...
import { cervixAnalysisService, doctorService } from "@/lib/api-services"
import {
  FileText,
  Download,
  Eye,
    ...
    const loadReports = async () => {
      ...
      try {
        ...
        for (const analysis of analyses) {
          ...
          const createdDateObj = analysis.createdAt?.toDate ? analysis.createdAt.toDate() : new Date(analysis.createdAt || Date.now())
          const reviewDateObj = analysis.doctorReviewAt
            ? (analysis.doctorReviewAt.toDate ? analysis.doctorReviewAt.toDate() : new Date(analysis.doctorReviewAt))
            : createdDateObj

          reportsData.push({
            id: analysis.id!,
            date: createdDateObj.toISOString().split("T")[0],
            ...
            reviewDate: reviewDateObj.toISOString().split("T")[0],
